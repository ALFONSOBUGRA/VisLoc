...
from visloc.tms.data_structures import FlightZone, TileImage
...
class GeoDataProcessor:
    ...
    Examples
    --------
    >>> from visloc.localization.data import GeoDataProcessor
    >>> from visloc.tms.data_structures import FlightZone
    >>> from pathlib import Path
